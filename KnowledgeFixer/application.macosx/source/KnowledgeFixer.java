...
public class KnowledgeFixer extends PApplet {
...
static final int linkedColor=0xff8080FF;
...
public Node addNode(String label, int size, String linkTo) {
...
class Node {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "KnowledgeFixer" });
  }
}
